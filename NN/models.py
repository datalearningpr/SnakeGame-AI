...
class NN_Snake(Snake):
    ...
    # , angle of the target, action)
    def get_state(self, target, action):            
    ...
    # method tot get the distance between start and target
    ...
    # method to set the snake direction based on input action
